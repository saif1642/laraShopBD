                ...
                @foreach($products as $product)
                  <tr class="gradeX">
                    ...
                    <td class="center">
                      ...
                      <a href="{{url('/admin/edit-product/'.$product->id)}}" class="btn btn-primary btn-mini" title="Edit Product Details">Edit</a> 
                      ...
                      <a rel="{{ $product->id }}" rel1="delete-product"  href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Product Record">Delete</a>
                    </td>
                  </tr>
